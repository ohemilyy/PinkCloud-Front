...
export default function Hydro() {
  return (
    <section id="hydro" className="flex flex-col p-6 pt-32 items-center gap-44">
      <div className="flex flex-col items-center gap-8">
        ...
        <span className="inline-flex justify-between gap-32">
          <span className="hero-p flex flex-col justify-center items-start">
      ...
      <div className="container-fluid py-4 py-xl-5">
        <div className='row mb-5'>
          <div className='col-md-8 col-xl-6 col-xxl-5 text-center mx-auto'>
        ...
        <div className='col-xxl-8 offset-xxl-2 smd'>
          <div className="col-xxl-7 offset-xxl-1 pt-5">
            <div className="card">
