...
export const Directors = () => {
  return (
    <div className="relative flex flex-row flex-wrap justify-center gap-7">
      ...
      <BioCard img="/img/emilyg.png"
               name="CEO - Emily G."
               discord="ohemilyy"
               github="ohemilyy"
               email="emily@pinkcloud.studio">
        Hey there, I'm Emily! A 22-year-old trans-  feminine individual with a deep passion for Astrophysics and Computer Science (C.S.).<br />
